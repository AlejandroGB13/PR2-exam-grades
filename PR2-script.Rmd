...
ggplot(newdata, aes(x=seq(1:1000), y=seq(0:100)))+
  geom_line(data = newdata, aes(x = seq(1:1000), y = reading.score), colour = 'purple')+
  geom_line(data = newdata, aes(x = seq(1:1000), y = writing.score), colour = 'cyan')+
  geom_line(data = newdata, aes(x = seq(1:1000), y = math.score), colour = 'black')+
  geom_line(data = newdata, aes(x = seq(1:1000), y = meangrade), colour = 'red', size = 1.5)+
  ggtitle("Notas de los estudiantes en todas las asignaturas")
```

Como podemos ver hay una clara linea de tendencia, siendo la linea negra las notas de los estudiantes en matemáticas, la morada las notas de lectura, la cían las notas de escritura y la línea roja la media.
